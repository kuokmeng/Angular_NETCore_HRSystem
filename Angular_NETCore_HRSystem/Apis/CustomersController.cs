  ...
  public class CustomersApiController : Controller
  {
    ...
    public async Task<ActionResult> Customers()
    {
      try
      {
        ...
        //var map = _mapper.Map<IEnumerable<EmployeeDto>>(customers);
        return Ok(customers);
      }
      catch (Exception exp)
      {
    ...
    {
      _Logger.LogInformation("UpdateCustomer start");
      ...
      try
      {
        _Logger.LogInformation("UpdateCustomer " + customer.FirstName + " " + customer.Email);
        //Google Oauth here
